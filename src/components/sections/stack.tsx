      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 gap-14 px-6 lg:grid-cols-3 lg:px-16">
        ...
        <div>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="brackets group mt-10 block rounded-xl border border-border bg-card/60 p-6 backdrop-blur-sm transition-all hover:border-primary/50 hover:bg-card"
          >
